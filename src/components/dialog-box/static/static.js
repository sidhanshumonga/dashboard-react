...
export default function Static(props) {
    ...
    return (
        <section>
            {type === 1 ? (<div id="mchart1" style={{ height: "75vh" }}></div>) :
                type === 2 ? (<div id="mchart2" style={{ height: "75vh" }}></div>) :
                    type === 3 ? (<div id="mchart3" style={{ height: "75vh" }}></div>) :
                        type === 4 ? (<div id="mchart4" style={{ height: "75vh" }}></div>) :
                            type === 5 ? (<table className="table table-bordered table-fn-xs p-3">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                type === 6 ? (<table className="table table-bordered table-fn-xs p-3">
                                <thead>
                                    <tr>
                                        <th>Period</th>
                                ...
                                </thead>
                                {
                                    ...
                                    type === 7 ? ( <table className="table table-bordered table-fn-xs p-3">
                                    <thead>
                                    ...
                                    <tbody>
                                        ...
                                        type === 8 ? (<table className="table table-bordered table-fn-xs p-3">
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            type === 9 ? (<table className="table table-bordered table-fn-xs p-3">
                                            <thead>
